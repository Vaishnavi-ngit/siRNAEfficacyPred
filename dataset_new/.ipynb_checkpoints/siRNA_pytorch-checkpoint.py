...
for n in range(1):
    ...
    data_train = pd.read_csv(f"siRNA_split_datasets/split0/train.csv")
    data_dev = pd.read_csv(f"siRNA_split_datasets/split0/dev.csv")
    data_test = pd.read_csv(f"siRNA_split_datasets/split0/test.csv")
