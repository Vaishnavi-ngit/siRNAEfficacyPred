...
# Load parameters
params = json.load(open("op.json", 'r'))
...
for n in range(10):
    ...
    # # mRNA nodes features
    # mrna_pd = pd.concat([mrna_embedding_df, mrna_sfold_feat, mrna_GC], axis=1)
    ...
    model_path = f"best_model_fold{n}_gcn.pt" # <--- IMPORTANT: Ensure this path is correct for your saved models
