...
# Read mrna file
mrna_file = f"mrna_Simone_small.fas"
mrna_map = []
...
# Read sirna file
sirna_file = f"sirna_Simone.fas"  # assuming FASTA format for siRNAs
sirna_map = []
...
efiicacy_file = pd.read_csv("Simone_efficacy.csv")
...
# eff_df[final_cols].to_csv("original.csv", index=False)
